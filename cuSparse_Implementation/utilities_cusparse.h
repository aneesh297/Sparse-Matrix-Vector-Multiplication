...
int checker(double *arr1, double *arr2, int size)
{
	float err = 0;
	int count = 0;
...
void simple_spmv(double *res, double *vect, double * values, int *col_idx, int *row_off, int nnz, int m,int n)
{
	for(int i = 0; i < n; i++)
	{
		res[i] = 0;
